...
import SuperAdminMetricsCard from '../../components/subscription/SuperAdminMetricsCard';
    ...
    if (isSuperAdmin) {
      const fetchOrgs = async () => {
        try {
          ...
          orgs.forEach((org) => {
            map[org.id] = org.name;
            if (org.tenantId) map[org.tenantId] = org.name;
          });
          setClientsMap(map);
        } catch (err) {
          console.error('Failed to load orgs for metrics mapping:', err);
        }
      };
      fetchOrgs();
    }
          ...
          <>
            ...
            <div className="flex space-x-1 border-b border-gray-200 mb-6">
              <button
                ...
                className={`py-3 px-6 text-sm font-medium border-b-2 transition-colors duration-200 cursor-pointer ${activeTab === 'overview'
              ...
              <button
                ...
                className={`py-3 px-6 text-sm font-medium border-b-2 transition-colors duration-200 cursor-pointer ${activeTab === 'ai-scribe'
                  ? 'border-cyan-500 text-cyan-600'
                  : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                  }`}
              >
            ...
            {activeTab === 'ai-scribe' ? (
              <SuperAdminMetricsCard
                activeProduct={{ name: 'AI Scribe One' }}
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <p className="text-sm text-gray-500">Total Clients 1</p>
