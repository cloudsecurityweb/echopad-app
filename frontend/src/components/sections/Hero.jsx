...
function Hero() {
  ...
  return (
    <FullScreenSection id="hero" className="bg-gradient-to-b from-slate-50 via-white to-slate-100/70">
    ...
    Your Entire Clinical Workflow
          ...
          <div className="flex flex-wrap justify-center gap-3 md:gap-2 lg:gap-3 xl:gap-4 2xl:gap-5 3xl:gap-6 mb-6 md:mb-5 lg:mb-6 xl:mb-8 2xl:mb-10 3xl:mb-12 animate-fade-in-scale animation-delay-300">
            <div className="flex items-center gap-1.5 md:gap-2 glass-card px-4 md:px-3 lg:px-4 xl:px-5 2xl:px-6 3xl:px-7 py-1 md:py-1.5 lg:py-2 xl:py-3 2xl:py-3.5 3xl:py-4 rounded-xl hover-scale group shadow-sm">
              <i className="bi bi-mic-fill text-blue-600 text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl 3xl:text-3xl group-hover:scale-110 transition-transform"></i>
            ...
            <div className="flex items-center gap-1.5 md:gap-2 glass-card px-4 md:px-3 lg:px-4 xl:px-5 2xl:px-6 3xl:px-7 py-1 md:py-1.5 lg:py-2 xl:py-3 2xl:py-3.5 3xl:py-4 rounded-xl hover-scale group shadow-sm">
              <i className="bi bi-headset text-blue-600 text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl 3xl:text-3xl group-hover:scale-110 transition-transform"></i>
            ...
            <div className="flex items-center gap-1.5 md:gap-2 glass-card px-4 md:px-3 lg:px-4 xl:px-5 2xl:px-6 3xl:px-7 py-1 md:py-1.5 lg:py-2 xl:py-3 2xl:py-3.5 3xl:py-4 rounded-xl hover-scale group shadow-sm">
              <i className="bi bi-bell text-blue-600 text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl 3xl:text-3xl group-hover:scale-110 transition-transform"></i>
          ...
          <div className="flex flex-col sm:flex-row gap-3 lg:gap-4 xl:gap-5 2xl:gap-6 3xl:gap-7 justify-center mb-4 md:mb-4 lg:mb-5 xl:mb-6 2xl:mb-8 3xl:mb-10 animate-fade-in-scale animation-delay-400">
            <a
              href="/sign-up"
              className="inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-6 md:px-5 lg:px-6 xl:px-8 2xl:px-10 3xl:px-12 py-3 md:py-2.5 lg:py-3 xl:py-4 2xl:py-5 3xl:py-6 rounded-xl hover:bg-blue-700 transition-all font-semibold text-sm md:text-sm lg:text-base xl:text-lg 2xl:text-xl 3xl:text-2xl shadow-lg hover:scale-105 hover-glow"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 glass-card border-2 border-slate-300 text-gray-800 px-6 md:px-5 lg:px-6 xl:px-8 2xl:px-10 3xl:px-12 py-3 md:py-2.5 lg:py-3 xl:py-4 2xl:py-5 3xl:py-6 rounded-xl hover:bg-slate-50 hover:border-blue-400 transition-all font-semibold text-sm md:text-sm lg:text-base xl:text-lg 2xl:text-xl 3xl:text-2xl hover:scale-105 shadow-sm"
            >
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-5 lg:gap-6 xl:gap-8 2xl:gap-10 3xl:gap-12 animate-fade-in-scale animation-delay-500">
            <div className="text-center">
              <div className="text-sm md:text-sm lg:text-base xl:text-lg 2xl:text-xl 3xl:text-2xl font-bold text-gray-900">2+ hours</div>
            ...
            <div className="text-center">
              <div className="text-sm md:text-sm lg:text-base xl:text-lg 2xl:text-xl 3xl:text-2xl font-bold text-gray-900">70%</div>
            ...
            <div className="text-center">
              <div className="text-sm md:text-sm lg:text-base xl:text-lg 2xl:text-xl 3xl:text-2xl font-bold text-gray-900">95%</div>
