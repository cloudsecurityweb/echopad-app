          ...
          <div className="glass-card rounded-3xl p-4 md:p-5 lg:p-6 xl:p-8 2xl:p-10 3xl:p-14 shadow-xl relative overflow-hidden border border-gray-200">
            ...
            <div className="relative z-10 flex flex-col gap-3 md:gap-4 lg:gap-6 xl:gap-8 2xl:gap-10 3xl:gap-12">
              <div className="text-center">
                <div className="text-xs 2xl:text-sm 3xl:text-base font-semibold bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent uppercase tracking-widest mb-1.5 md:mb-2 lg:mb-3 2xl:mb-4">
                  ROI Snapshot
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-3 lg:gap-4 xl:gap-5 2xl:gap-6 3xl:gap-8">
                <div className="glass-card rounded-2xl p-2.5 md:p-3 lg:p-4 xl:p-5 2xl:p-6 3xl:p-8 text-center hover-lift shadow-sm">
                  <div className="w-8 h-8 md:w-9 md:h-9 lg:w-10 lg:h-10 xl:w-12 xl:h-12 2xl:w-14 2xl:h-14 3xl:w-16 3xl:h-16 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-1.5 md:mb-2 lg:mb-3 xl:mb-4 2xl:mb-5 3xl:mb-6 shadow-md">
                    <i className="bi bi-currency-dollar text-white text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl 3xl:text-3xl"></i>
                  </div>
                  <div className="text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl 3xl:text-6xl font-bold bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent mb-0.5 md:mb-1 lg:mb-2 2xl:mb-3">$180K</div>
                ...
                <div className="glass-card rounded-2xl p-2.5 md:p-3 lg:p-4 xl:p-5 2xl:p-6 3xl:p-8 text-center hover-lift shadow-sm">
                  ...
                  <div className="text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl 3xl:text-6xl font-bold bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent mb-0.5 md:mb-1 lg:mb-2 2xl:mb-3">60%</div>
                ...
                <div className="glass-card rounded-2xl p-2.5 md:p-3 lg:p-4 xl:p-5 2xl:p-6 3xl:p-8 text-center hover-lift shadow-sm">
                  ...
                  <div className="text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl 3xl:text-6xl font-bold bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent mb-0.5 md:mb-1 lg:mb-2 2xl:mb-3">40%</div>
