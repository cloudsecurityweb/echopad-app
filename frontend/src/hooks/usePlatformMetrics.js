...
import { fetchPlatformMetrics } from '../api/metrics.api';

/**
 * Fetches aggregated transcription metrics for the global platform.
 ...
 */
export function usePlatformMetrics({ dateRange, enabled = true } = {}) {
    ...
    const fetch = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetchPlatformMetrics(params);
