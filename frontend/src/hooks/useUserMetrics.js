...
import { fetchUserMetrics } from '../api/metrics.api';

/**
 * Fetches aggregated transcription metrics for the current user.
 ...
 */
export function useUserMetrics({ dateRange, enabled = true } = {}) {
    ...
    const fetch = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetchUserMetrics(params);
