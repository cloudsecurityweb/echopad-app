...
export default function HelpDocCard({ doc, onEdit, onClick }) {
  const statusStyles =
  ...
  return (
    <div
      className={`bg-white border-2 border-gray-200 rounded-2xl p-6 shadow-sm hover:border-blue-300 transition ${onClick ? 'cursor-pointer' : ''}`}
